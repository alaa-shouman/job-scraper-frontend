        ...
        <article className="group relative flex flex-col rounded-2xl bg-surface border border-glacier/60 hover:border-primary/40 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 overflow-hidden">
            ...
            <div className="p-5 flex flex-col gap-4 flex-1">
                ...
                <div className="flex flex-wrap items-center gap-2 text-xs text-ink-mid">
                    ...
                    {/* Job Level */}
                    {job.jobLevel && (
                        <span className="inline-flex items-center rounded-md bg-violet-50 border border-violet-200 text-violet-700 px-2 py-0.5 font-medium">
                            {job.jobLevel}
                        </span>
                    )}
                    ...
                    {job.relevanceScore !== undefined && (
                        <span className="inline-flex items-center gap-1 rounded-md bg-amber-50 border border-amber-200 text-amber-700 px-2 py-0.5 font-medium">
